    ...
    <basic-container>
      <template>
        <el-tabs @tab-click="switchTab">
          <el-tab-pane label='息管理' name='userManager'/>
          <el-tab-pane label='码管理' name='passwordManager'/>
        </el-tabs>
      </template>
      <el-row>
        <el-col :span="12">
            ...
            <el-form :model="ruleForm2"
              ...
              <el-form-item>
                <el-button type="primary"
                           @click="submitForm('ruleForm2')">提
                </el-button>
                <el-button @click="resetForm('ruleForm2')">重</el-button>
              </el-form-item>
            </el-form>
            <el-form :model="ruleForm2"
                     :rules="rules2"
